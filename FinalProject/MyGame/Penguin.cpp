...
void Penguin::draw() const
{
	...
	// ¹ß ±×¸®±â
	{
		glm::mat4 moveYMat = glm::translate(unitMat, glm::vec3(0.f, 0.5f, 0.f));	// °íÁ¤°ª..
	...
	// ÆÈ ±×¸®±â
	{
		...
		glm::mat4 scaleMat = glm::scale(unitMat, glm::vec3(0.0625f, 0.5f, 0.2f)); // ÆÈ Å©±â

		// ¾î±ú À§Ä¡ ¼³Á¤ (¸öÅëÀÇ À­ºÎºÐ ¾ç¿·)
		glm::mat4 moveleftPos = glm::translate(unitMat, glm::vec3(-0.2f, 0.2f, 0.f)); // ¿ÞÂÊ ¾î±ú
		glm::mat4 moveRightPos = glm::translate(unitMat, glm::vec3(0.2f, 0.2f, 0.f)); // ¿À¸¥ÂÊ ¾î±ú
	...
	// ´« ±×¸®±â
	{
		glm::mat4 moveYMat = glm::translate(unitMat, glm::vec3(0.f, 0.6f, 0.f));	// °íÁ¤°ª..
