...
void Scene::initialize()
{
	...
	//for (int i = 0; i < 20; ++i) {
	//	townObjects[i] = new TownObject;
	//	townObjects[i]->setShader(BackGroundShader);
	//	//townObjects[i]->setVAO(fenceVAO, fenceVertexCount);
	//	//townObjects[i]->setPosition(0.f, 0.f, 0.f);
	//}
